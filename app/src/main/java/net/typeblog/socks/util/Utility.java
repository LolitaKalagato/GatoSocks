...
import static net.typeblog.socks.util.Constants.INTENT_APP_BYPASS;
import static net.typeblog.socks.util.Constants.INTENT_APP_LIST;
import static net.typeblog.socks.util.Constants.INTENT_DNS;
import static net.typeblog.socks.util.Constants.INTENT_DNS_PORT;
import static net.typeblog.socks.util.Constants.INTENT_IPV6_PROXY;
import static net.typeblog.socks.util.Constants.INTENT_NAME;
import static net.typeblog.socks.util.Constants.INTENT_PASSWORD;
import static net.typeblog.socks.util.Constants.INTENT_PER_APP;
import static net.typeblog.socks.util.Constants.INTENT_PORT;
import static net.typeblog.socks.util.Constants.INTENT_ROUTE;
import static net.typeblog.socks.util.Constants.INTENT_SERVER;
import static net.typeblog.socks.util.Constants.INTENT_UDP_GW;
import static net.typeblog.socks.util.Constants.INTENT_USERNAME;
